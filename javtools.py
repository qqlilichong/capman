...
from webtools import http_get, http_urljoin

######################################################
# Format input to json string.
...
######################################################
# Parse HTML source code from file.
def javlib_parse_html(file, path, encoding='utf-8'):
    pagedict = {}
    try:
        with open(file, encoding=encoding) as source:
